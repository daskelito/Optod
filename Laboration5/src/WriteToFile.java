...
public class WriteToFile {
    ...
    public void action() {
        ...
        while (choice != 7) {
            try {
                switch (choice) {
                    case 1:
                        writePersons("C:\\Users\\Dragon\\IdeaProjects\\Optod\\Laboration5\\files\\persons.dat");
                        break;
                    case 2:
                        readPersons("C:\\Users\\Dragon\\IdeaProjects\\Optod\\Laboration5\\files\\persons.dat");
                        printPersons();
                        break;
                    case 3:
                        writeInvited("C:\\Users\\Dragon\\IdeaProjects\\Optod\\Laboration5\\files\\invited.txt");
                        break;
                    case 4:
                        readInvited("C:\\Users\\Dragon\\IdeaProjects\\Optod\\Laboration5\\files\\invited.txt");
                        printInvited();
                        break;
                    case 5:
                        writePrimes("C:\\Users\\Dragon\\IdeaProjects\\Optod\\Laboration5\\files\\primtal.dat");
                        break;
                    case 6:
                        readPrimes("C:\\Users\\Dragon\\IdeaProjects\\Optod\\Laboration5\\files\\primtal.dat");
                        printPrimes();
                        break;
                }
            } catch (IOException e) {
    ...
    public void writeInvited(String filename) throws IOException {
        try (BufferedWriter bos = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(filename), "UTF-8"))) {
